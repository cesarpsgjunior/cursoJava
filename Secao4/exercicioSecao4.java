...
public class exercicioSecao4 {
	...
	public static void main(String[] args) {
		 ...
		 * casas decimais.
		 * 
		 * Locale.setDefault(Locale.US); int numFuncionario, horasTrabalhadas; double
		 * salario, valorHora;
		 * 
		 * System.out.println("Digite os valores seguidos de enter");
		 * System.out.println("Numero do funcionario: "); numFuncionario = sc.nextInt();
		 * System.out.println("Total de horas trabalhadas: "); horasTrabalhadas =
		 * sc.nextInt(); System.out.println("Valor por hora"); valorHora =
		 ...
		 * 
		 * 
		 * Locale.setDefault(Locale.US); int codigoPeca1, numPecas1, codigoPeca2,
		 * numPecas2; double valUnit1, valUnit2;
		 * 
		 * System.out.
		 * println("Digite o código da peça, quantidade e valor unitario com ponto");
		 * codigoPeca1 = sc.nextInt(); numPecas1 = sc.nextInt(); valUnit1 =
		 * sc.nextDouble();
		 * 
		 * System.out.
		 * println("Digite o código da peça, quantidade e valor unitario com ponto");
		 * codigoPeca2 = sc.nextInt(); numPecas2 = sc.nextInt(); valUnit2 =
		 * sc.nextDouble();
		 * 
		 * 
		 * System.out.println("Valor a pagar: R$ " + (double)(numPecas1 * valUnit1 +
		 * numPecas2 * valUnit2));
		 */
		// -------------------------------------------------------------------------------------//
